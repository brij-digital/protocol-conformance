  ...
  it('matches SDK instruction encoding and remaining accounts for swap_base_in', async () => {
    const prepared = await prepareRuntimeInstruction({
      ...
      input: {
        ...
        tick_array_0: CLMM_SWAP_FIXTURE.tickArrays[0].toBase58(),
        tick_array_1: CLMM_SWAP_FIXTURE.tickArrays[1].toBase58(),
        tick_array_2: CLMM_SWAP_FIXTURE.tickArrays[2].toBase58(),
